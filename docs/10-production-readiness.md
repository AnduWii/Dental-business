...
| 7 | Dependency scanning & patching | ✅ | **Dependabot** (`.github/dependabot.yml`) + `npm audit` in CI. (Already patched Next.js to a non-vulnerable release.) |
...
| 10 | Regulatory compliance (GDPR/HIPAA) | 🟡 | Real regime for Ontario is **PIPEDA/PHIPA + CASL**; GDPR-style erasure/access supported. HIPAA generally N/A (not a US covered entity). Full analysis in `docs/12-compliance-privacy.md`. |
